...
* If you write code block that needs to be executed, you have to put 'ENDOFTURN' right after the code block, so that the user can run the code and provide the output.
