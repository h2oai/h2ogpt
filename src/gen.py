...
def main(
        load_8bit: bool = bool(os.environ.get('LOAD_8BIT', False)),
        load_4bit: bool = bool(os.environ.get('LOAD_4BIT', False)),
        load_half: bool = bool(os.environ.get('LOAD_HALF', True)),
        load_gptq: str = os.environ.get('LOAD_GPTQ', ''),
        load_exllama: bool = bool(os.environ.get('LOAD_EXLLAMA', False)),
        use_safetensors: bool = bool(os.environ.get('USE_SAFETENSORS', False)),
        revision: str = os.environ.get('REVISION', None),
        use_gpu_id: bool = bool(os.environ.get('USE_GPU_ID', True)),
        base_model: str = os.environ.get('BASE_MODEL', ''),
        tokenizer_base_model: str = os.environ.get('TOKENIZER_BASE_MODEL', ''),
        lora_weights: str = os.environ.get('LORA_WEIGHTS', ""),
        gpu_id: int = int(os.environ.get('GPU_ID', 0)),
        compile_model: bool = bool(os.environ.get('COMPILE_MODEL', True)),
        use_cache: bool = bool(os.environ.get('USE_CACHE', None)),
        inference_server: str = os.environ.get('INFERENCE_SERVER', ""),
        prompt_type: Union[int, str] = None,
        prompt_dict: typing.Dict = None,

        model_lock: typing.List[typing.Dict[str, str]] = None,
        model_lock_columns: int = int(os.environ.get('MODEL_LOCK_COLUMNS', None)),
        fail_if_cannot_connect: bool = bool(os.environ.get('FAIL_IF_CANNOT_CONNECT', False)),

        # input to generation
        temperature: float = float(os.environ.get('TEMPERATURE', None)),
        top_p: float = float(os.environ.get('TOP_P', None)),
        top_k: int = int(os.environ.get('TOP_K', None)),
        num_beams: int = int(os.environ.get('NUM_BEAMS', None)),
        repetition_penalty: float = float(os.environ.get('REPETITION_PENALTY', None)),
        num_return_sequences: int = int(os.environ.get('NUM_RETURN_SEQUENCES', None)),
        do_sample: bool = bool(os.environ.get('DO_SAMPLE', None)),
        max_new_tokens: int = int(os.environ.get('MAX_NEW_TOKENS', None)),
        min_new_tokens: int = int(os.environ.get('MIN_NEW_TOKENS', None)),
        early_stopping: Union[bool, str] = None,
        max_time: float = float(os.environ.get('MAX_TIME', None)),

        memory_restriction_level: int = int(os.environ.get('MEMORY_RESTRICTION_LEVEL', None)),
        debug: bool = bool(os.environ.get('DEBUG', False)),
        save_dir: str = os.environ.get('SAVE_DIR', None),
        share: bool = bool(os.environ.get('SHARE', False)),
        local_files_only: bool = bool(os.environ.get('LOCAL_FILES_ONLY', False)),
        resume_download: bool = bool(os.environ.get('RESUME_DOWNLOAD', True)),
        ...
        tgt_lang: str = os.environ.get('TGT_LANG', "Russian"),

        cli: bool = bool(os.environ.get('CLI', False)),
        ...
        show_examples: bool = bool(os.environ.get('SHOW_EXAMPLES', None)),
        verbose: bool = bool(os.environ.get('VERBOSE', False)),
        h2ocolors: bool = bool(os.environ.get('H2OCOLORS', True)),
        dark: bool = bool(os.environ.get('DARK', False)),  # light tends to be best
        height: int = int(os.environ.get('HEIGHT', 600)),
        show_lora: bool = bool(os.environ.get('SHOW_LORA', True)),
        login_mode_if_model0: bool = bool(os.environ.get('LOGIN_MODE_IF_MODEL0', False)),
        block_gradio_exit: bool = bool(os.environ.get('BLOCK_GRADIO_EXIT', True)),
        concurrency_count: int = int(os.environ.get('CONCURRENCY_COUNT', 1)),
        api_open: bool = bool(os.environ.get('API_OPEN', False)),
        ...
        sanitize_user_prompt: bool = bool(os.environ.get('SANITIZE_USER_PROMPT', False)),
        sanitize_bot_response: bool = bool(os.environ.get('SANITIZE_BOT_RESPONSE', False)),

        extra_model_options: typing.List[str] = [],
        extra_lora_options: typing.List[str] = [],
        extra_server_options: typing.List[str] = [],

        score_model: str = os.environ.get('SCORE_MODEL', 'auto'),

        eval_filename: str = os.environ.get('EVAL_FILENAME', None),
        eval_prompts_only_num: int = int(os.environ.get('EVAL_PROMPTS_ONLY_NUM', 0)),
        eval_prompts_only_seed: int = int(os.environ.get('EVAL_PROMPTS_ONLY_SEED', 1234)),
        eval_as_output: bool = bool(os.environ.get('EVAL_AS_OUTPUT', False)),

        langchain_mode: str = os.environ.get('LANGCHAIN_MODE', None),
        langchain_action: str = os.environ.get('LANGCHAIN_ACTION', LangChainAction.QUERY.value),
        langchain_agents: list = [],
        force_langchain_evaluate: bool = bool(os.environ.get('FORCE_LANGCHAIN_EVALUATE',False)),
        ...
        detect_user_path_changes_every_query: bool = bool(os.environ.get('DETECT_USER_PATH_CHANGES_EVERY_QUERY', False)),
        use_llm_if_no_docs: bool = bool(os.environ.get('USE_LLM_IF_NO_DOCS', True)),
        load_db_if_exists: bool = bool(os.environ.get('LOAD_DB_IF_EXISTS', True)),
        keep_sources_in_context: bool = bool(os.environ.get('KEEP_SOURCES_IN_CONTEXT', False)),
        use_system_prompt: bool = bool(os.environ.get('USE_SYSTEM_PROMPT', False)),
        db_type: str = os.environ.get('DB_TYPE', 'chroma'),
        use_openai_embedding: bool = bool(os.environ.get('USE_OPENAI_EMBEDDING', False)),
        use_openai_model: bool = bool(os.environ.get('USE_OPENAI_MODEL', False)),
        hf_embedding_model: str = os.environ.get('HF_EMBEDDING_MODEL', None),
        cut_distance: float = float(os.environ.get('CUT_DISTANCE', 1.64)),
        add_chat_history_to_context: bool = bool(os.environ.get('ADD_CHAT_HISTORY_TO_CONTEXT', True)),
        allow_upload_to_user_data: bool = bool(os.environ.get('ALLOW_UPLOAD_TO_USER_DATA', True)),
        reload_langchain_state: bool = bool(os.environ.get('RELOAD_LANGCHAIN_STATE', True)),
        allow_upload_to_my_data: bool = bool(os.environ.get('ALLOW_UPLOAD_TO_MY_DATA', True)),
        enable_url_upload: bool = bool(os.environ.get('ENABLE_URL_UPLOAD', True)),
        enable_text_upload: bool = bool(os.environ.get('ENABLE_TEXT_UPLOAD', True)),
        enable_sources_list: bool = bool(os.environ.get('ENABLE_SOURCES_LIST', True)),
        chunk: bool = bool(os.environ.get('CHUNK', True)),
        chunk_size: int = int(os.environ.get('CHUNK_SIZE', 512)),
        top_k_docs: int = int(os.environ.get('TOP_K_DOCS', None)),
        reverse_docs: bool = bool(os.environ.get('REVERSE_DOCS', True)),
        auto_reduce_chunks: bool = bool(os.environ.get('AUTO_REDUCE_CHUNKS', True)),
        max_chunks: int = int(os.environ.get('MAX_CHUNKS', 100)),
        n_jobs: int = int(os.environ.get('N_JOBS', -1)),
        enable_captions: bool = bool(os.environ.get('ENABLE_CAPTIONS', True)),
        captions_model: str = os.environ.get('CAPTIONS_MODEL', "Salesforce/blip-image-captioning-base"),
        pre_load_caption_model: bool = bool(os.environ.get('PRE_LOAD_CAPTION_MODEL', False)),
        caption_gpu: bool = bool(os.environ.get('CAPTION_GPU', True)),
        enable_ocr: bool = bool(os.environ.get('ENABLE_OCR', False)),
        enable_pdf_ocr: str = os.environ.get('ENABLE_PDF_OCR', 'auto'),
):
    """
