...
"""
        ...
        assert all_docs_start_prompt is not None and all_docs_finish_prompt is not None, 'Must set both all_docs_start_prompt and all_docs_finish_prompt if set either'
