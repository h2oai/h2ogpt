...
git pull --rebase
rm -rf app.py gen.py gradio_runner.py h2o-logo.svg LICENSE stopping.py prompter.py enums.py utils.py utils_langchain.py client_test.py gpt_langchain.py create_data.py h2oai_pipeline.py gpt4all_llm.py loaders.py requirements.txt iterators reqs_optional gradio_utils gradio_themes.py
cd ../h2ogpt/spaces/chatbot/
cp -rL gen.py gradio_runner.py gradio_themes.py h2o-logo.svg LICENSE stopping.py prompter.py enums.py utils.py utils_langchain.py client_test.py gpt_langchain.py create_data.py h2oai_pipeline.py gpt4all_llm.py loaders.py requirements.txt iterators reqs_optional gradio_utils ../../../"${spacename}"/
cd ../../../"${spacename}"/
...
git add app.py gen.py gradio_runner.py gradio_themes.py h2o-logo.svg LICENSE stopping.py prompter.py enums.py utils.py utils_langchain.py gpt_langchain.py create_data.py client_test.py h2oai_pipeline.py gpt4all_llm.py loaders.py requirements.txt iterators gradio_utils
