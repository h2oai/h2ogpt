...
test:
	...
	$(PYTHON_BINARY) -m pytest tests/test_cli.py --disable-warnings --junit-xml=test_cli_report.xml -m "$(DEFAULT_MARKERS)"
	$(PYTHON_BINARY) -m pytest tests/test_client_calls.py --disable-warnings --junit-xml=test_client_calls_report.xml -m "$(DEFAULT_MARKERS)"
	$(PYTHON_BINARY) -m pytest tests/test_eval_models.py --disable-warnings --junit-xml=test_eval_models_report.xml -m "$(DEFAULT_MARKERS)"
	$(PYTHON_BINARY) -m pytest tests/test_eval.py --disable-warnings --junit-xml=test_eval_report.xml -m "$(DEFAULT_MARKERS)"
