...
/h2ogpt_conda/vllm_env/bin/python -m pip install mosaicml-turbo==0.0.9 megablocks==0.5.1 ray pandas gputil==1.4.0 fschat==0.2.34 flash-attn==2.4.2 autoawq==0.1.8 uvicorn[standard]
